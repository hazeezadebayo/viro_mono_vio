...
class MonoVLaneNode(Node):
    def __init__(self):
        super().__init__('mono_vlane_node')
        ...
        self.cmd_vel_msg = Twist() # publish Twist messages for navigation
...
def main(args=None):
    ...
    mono_vlane_node = MonoVLaneNode()
    rclpy.spin(mono_vlane_node)
    mono_vlane_node.destroy_node()
    rclpy.shutdown()
